<template>
	<div class="filter-container">
		...
		<div
			class="filter-info-bar"
			:class="{ 'filter-panel-open': isFilterExpanded }"
		>
		...
		<VExpandXTransition mode="out-in">
			...
			>
				<VCard
					elevation="4"
					class="h-100 d-flex flex-column filter-card"
					tile
				>
...
<script setup lang="ts">
	...
	import { ActivityHistoryFilter } from '@/core/activityHistory/dto/request/ActivityHistoryFilter.ts'
