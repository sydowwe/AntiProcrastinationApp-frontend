...
<script setup lang="ts">
	...
	import RoleTable from '@/components/activity/activityRole/ActivityRoleTable.vue'
	import CategoryTable from '@/components/activity/activityCategory/ActivityCategoryTable.vue'
