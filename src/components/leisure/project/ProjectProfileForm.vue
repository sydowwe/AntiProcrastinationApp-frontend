...
<script setup lang="ts">
	...
	import { useActivityProjectProfileCrud } from '@/api/leisure/activityProjectProfileApi.ts'
	import NewProjectProfileForm from '@/components/leisure/project/NewProjectProfileForm.vue'
	import { useDialogApi } from '@/composables/general/useDialog.ts'
	import type { ActivityProjectProfile } from '@/dtos/response/leisure/ActivityProjectProfile.ts'
