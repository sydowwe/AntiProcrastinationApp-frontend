    ...
    <VRow justify="center" class="mt-16">
        <VCol cols="12" sm="10" md="8" lg="6">
            ...
            <VForm ref="form" @submit.prevent="validateAndSendForm" class="d-flex flex-column">
                <VTextField class="mb-3" :label="i18n.t('authorization.name')" v-model="formData.name" :rules="nameRules" autofocus></VTextField>
                <VTextField class="mb-3" :label="i18n.t('authorization.surname')" v-model="formData.surname" :rules="surnameRules"></VTextField>
