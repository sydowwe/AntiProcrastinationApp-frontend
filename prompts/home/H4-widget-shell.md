...
- **Backend:** none
- **Model / effort:** Opus 5, high — a slot API that has to fit five different bodies without becoming a leaky config object; getting the flex/overflow contract right is the whole job.
