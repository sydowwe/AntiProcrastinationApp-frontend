	...
	<div class="d-flex">
		<div class="time-column d-flex flex-column justify-space-between align-center">
			<div class="d-flex align-center w-100">
				<VSheet
					class="time-label pa-1 w-100 text-body-2 text-center font-weight-medium"
					rounded="lg"
					color="surface-light"
				>
			...
			<div class="d-flex align-center w-100">
				<VSheet
					class="time-label pa-1 w-100 text-body-2 text-center text-medium-emphasis"
					rounded="lg"
					color="surface-light"
				>
			...
			<div class="flex-fill">
				<div class="d-flex align-center">
					...
					>
						...
						<VTooltip
							v-if="record.activity.role?.text"
							activator="parent"
				...
				<VCardSubtitle
					v-if="record.activity.category"
					class="text-high-emphasis"
					style="opacity: 1"
				>
					<VIcon
						:icon="record.activity.category.icon ?? 'layer-group'"
						size="12"
						class="mr-1"
					/>
				...
				<VCardText
					v-if="record.activity.text"
					class="px-4 pb-3 text-body-2 text-medium-emphasis"
...
<script setup lang="ts">
	...
	import { formatToTime } from '@/_common/utils/DateTimeHelper.ts'
	...
	const formattedEndTimestamp = computed(() =>
		getEndOfActivityTime(props.record.startTimestamp, props.record.length.getInSeconds),
	)
