...
- **Model / effort:** Opus 5, high — this is module-level mutable state shared by two components with a hand-rolled cache; the failure modes are subtle and easy to
  reintroduce.
