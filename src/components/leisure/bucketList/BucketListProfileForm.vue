...
<script setup lang="ts">
	...
	import { useActivityBucketListProfileCrud } from '@/api/leisure/activityBucketListProfileApi.ts'
	import NewBucketListProfileForm from '@/components/leisure/bucketList/NewBucketListProfileForm.vue'
	import { useDialogApi } from '@/composables/general/useDialog.ts'
	import type { ActivityBucketListProfile } from '@/dtos/response/leisure/ActivityBucketListProfile.ts'
