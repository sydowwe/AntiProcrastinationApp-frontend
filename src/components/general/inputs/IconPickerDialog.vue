		...
		<VCard>
			...
			<VCardText class="pa-4">
				...
				<div class="d-flex flex-wrap align-center ga-3 mb-4">
					...
					<div class="text-caption text-medium-emphasis">{{ filteredIcons.length }} ikon</div>

					<VBtnToggle
						v-model="selectedStyle"
						mandatory
						color="secondary"
						baseColor="secondary-container"
						density="compact"
						divided
					>
						<VBtn
			...
			<VCardActions class="pa-4">
				...
				>
					...
					<VIcon
						:icon="toVuetifyIcon(selectedIcon)"
						class="mr-1"
						size="32"
					/>
