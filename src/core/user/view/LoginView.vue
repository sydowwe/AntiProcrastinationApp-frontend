				...
				>
					...
					<VRow justify="center">
						...
						<VCol
							cols="12"
							sm="6"
							class="d-flex align-center justify-start justify-sm-end pt-2 pt-sm-3"
						>
							<RouterLink
								class="mx-3"
...
<script setup lang="ts">
	...
	import GoogleSignIn from '@/core/user/component/GoogleSignIn.vue'
	import LoginVerifyQrCode from '@/core/user/component/LoginVerifyQrCode.vue'
	import ResendConfirmationEmail from '@/core/user/component/ResendConfirmationEmail.vue'
			...
			API.post('/auth/login', JSON.stringify(loginRequest.value))
				...
				.catch(error => {
					if (error.response.status === 401) {
						const tooManyAttemptsErrorMessage = error.response.data.errors.generalErrors.find((e: string) =>
