...
import { useDragAndDropMonitor } from '@/core/todoList/composable/dragAndDrop/UseDragAndDropMonitor.ts'
...
export function useTodoListDragAndDrop<TEntity extends IBaseToDoListItem>(
	...
	const { items, listId, activityIds, isInChangeOrderMode, emptyDropZoneRef, onSameListDrop, onCrossListDrop } =
		options

	const { setupGlobalMonitor, globalIsDragging, globalDraggedActivityId, globalDraggedSourceListId } =
